        ...
        <div className="w-full max-w-md space-y-8 bg-white dark:bg-slate-800 p-8 md:p-10 rounded-3xl shadow-xl border border-slate-100 dark:border-slate-700">
            ...
            <form onSubmit={handleLoginSubmit} className="space-y-5">
                ...
                <div className="flex items-center justify-between text-sm">
                    ...
                    <button type="button" className="text-indigo-600 hover:text-indigo-700 dark:text-indigo-400 dark:hover:text-indigo-300 font-semibold transition-colors">
                        Esqueci minha senha
                    </button>
                </div>
            ...
            <div className="relative flex items-center gap-4 my-6">
                ...
                <span className="text-xs text-slate-400 uppercase tracking-wider font-bold">Ou conecte-se com</span>
                <div className="h-px bg-slate-200 dark:bg-slate-700 flex-1"></div>
            </div>
            ...
            <button
                ...
                disabled={isLoading}
                className="w-full flex items-center justify-center gap-3 bg-white dark:bg-slate-700 text-slate-700 dark:text-white border border-slate-200 dark:border-slate-600 hover:bg-slate-50 dark:hover:bg-slate-600 py-3.5 px-4 rounded-xl font-medium transition-all shadow-sm hover:shadow-md disabled:opacity-70 disabled:cursor-not-allowed"
            >
                {/* Google Icon SVG */}
