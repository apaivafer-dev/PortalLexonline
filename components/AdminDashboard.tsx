...
export const AdminDashboard = ({ users, onToggleUserStatus, onUpdateUserPlan, onCreateUser }: AdminDashboardProps) => {
            ...
            <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-6 bg-white dark:bg-[#1A1D23] p-8 rounded-[32px] shadow-[0_2px_20px_rgba(0,0,0,0.02)] dark:shadow-none border border-slate-100 dark:border-white/5">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-3 w-full xl:w-auto">
                    ...
                    <button
                        ...
                        className="px-4 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl text-sm font-bold transition-colors shadow-sm flex items-center gap-2 h-[48px]"
                    >
                    ...
                    <div className="bg-white dark:bg-[#1A1D23] rounded-3xl w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-2xl animate-in zoom-in-95 duration-200 flex flex-col relative" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="p-8 space-y-8">
                            ...
                            <div className="bg-slate-100 dark:bg-black/30 p-4 rounded-xl flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    <span className="text-sm font-bold text-slate-600 dark:text-slate-400">Acesso ao Sistema:</span>
                                    <button
                    ...
                    <div className="bg-white dark:bg-[#1A1D23] rounded-3xl w-full max-w-lg shadow-2xl animate-in zoom-in-95 duration-200" onClick={(e) => e.stopPropagation()}>
                        <div className="p-6 border-b border-slate-100 dark:border-white/5 flex justify-between items-center">
                            <h3 className="text-xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
                                <Plus size={20} className="text-indigo-600" /> Criar Novo Usuário
                            </h3>
                            <button onClick={() => setShowCreateForm(false)} className="p-2 hover:bg-slate-100 dark:hover:bg-white/10 rounded-full transition-colors">
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <div>
                                ...
                                <input type="password" value={createForm.password} onChange={(e) => setCreateForm(p => ({ ...p, password: e.target.value }))}
                                    className="w-full px-4 py-3 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl text-sm font-medium outline-none focus:ring-2 focus:ring-indigo-500 dark:text-white" placeholder="Mínimo 6 caracteres" />
                            </div>
                        ...
                        <div className="p-6 border-t border-slate-100 dark:border-white/5 flex justify-end gap-3">
                            <button onClick={() => setShowCreateForm(false)} className="px-6 py-3 text-sm font-bold text-slate-600 hover:bg-slate-100 dark:text-slate-400 dark:hover:bg-white/5 rounded-xl transition-colors">
                                Cancelar
                            </button>
