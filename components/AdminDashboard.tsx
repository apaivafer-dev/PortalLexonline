...
import { Users, CreditCard, Award, Image, IdCard, ShieldAlert, CheckCircle, XCircle, Search, Power, MoreHorizontal, Calendar, ArrowRight, ChevronDown, Eye, Building2, TrendingUp, Mail, Phone, Globe, Lock, User, Filter, AlertTriangle } from 'lucide-react';
...
export const AdminDashboard = ({ users, onToggleUserStatus, onUpdateUserPlan }: AdminDashboardProps) => {
